...
employeeController.createResponse = async (req, res, next) => {
  const { week, employee_id, question_0, question_1, question_2, question_3 } = req.body;
  reqArray = [week, employee_id, question_0, question_1, question_2, question_3]
  const insertResponse = 'INSERT INTO survey(week, employee_id, question_0, question_1, question_2, question_3) VALUES ($1, $2, $3, $4, $5, $6);'
  try {
